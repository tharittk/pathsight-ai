...
WELL_LOCATIONS = [
    {
        ...
        "units": [
            ...
            {"name": "2D", "depth_from": 800,   "depth_to": 1800,
             "thickness_mean": 8.3,  "thickness_var": 1.4},
            {"name": "2C", "depth_from": 1800,  "depth_to": 3000,
    ...
    },
    {
        ...
        "units": [
            ...
            {"name": "2D", "depth_from": 750,   "depth_to": 1750,
    ...
    },
    {
        ...
        "units": [
            ...
            {"name": "2D", "depth_from": 900,   "depth_to": 1900,
             "thickness_mean": 7.8,  "thickness_var": 1.2},
            {"name": "2C", "depth_from": 1900,  "depth_to": 3200,
    ...
    },
    {
        ...
        "units": [
            ...
            {"name": "2D", "depth_from": 850,   "depth_to": 1850,
    ...
    },
    {
        ...
        "units": [
            ...
            {"name": "2D", "depth_from": 700,   "depth_to": 1700,
             "thickness_mean": 6.5,  "thickness_var": 1.0},
            {"name": "2C", "depth_from": 1700,  "depth_to": 2900,
    ...
    },
    {
        ...
        "units": [
            ...
            {"name": "2D", "depth_from": 820,   "depth_to": 1820,
